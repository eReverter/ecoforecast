...
from src.model.forecasting.lstm.model_training import prepare_data, create_sequences, LSTMModel  # Adjust import path
...
def load_model(model_path, input_size):
    ...
    model = LSTMModel(input_size, **model_config)
...
def main():
    ...
    # Normalize x_predict if you applied normalization during training
    scaler = StandardScaler()
    x_predict_scaled = scaler.fit_transform(x_predict.reshape(-1, x_predict.shape[2]))
    ...
    # You'll need the input size for your model
